...
/**
 * A {@link Polyline} which wraps an OMERO polygon Roi
 *
 * @author Alison Walter
 */
public interface OMEROPolyline extends OMEROShape<PolylineData>,
	Polyline<RealPoint>
{
	...
	default void addVertex(final int index, final RealLocalizable vertex) {
		getShape().getPoints().add(index, new Point2D.Double(vertex
			.getDoublePosition(0), vertex.getDoublePosition(1)));
	}
