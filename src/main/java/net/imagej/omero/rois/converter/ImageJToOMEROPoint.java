...
public class ImageJToOMEROPoint extends
	AbstractImageJMaskToOMEROShape<RealLocalizable, PointMask, PointData>
{
	...
	@Override
	public PointData convert(final PointMask mask) {
		return new PointData(mask.getDoublePosition(0), mask.getDoublePosition(1));
	}
