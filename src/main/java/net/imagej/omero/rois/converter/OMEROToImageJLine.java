...
import net.imagej.omero.rois.DefaultOMEROLine;
...
/**
 * Converts an OMERO {@link LineData} to {@link Line}.
 *
 * @author Alison Walter
 */
@Plugin(type = Converter.class)
public class OMEROToImageJLine extends
	AbstractOMEROShapeToImageJMask<LineData, Line<RealPoint>>
{
	...
	@Override
	public Line<RealPoint> convert(final LineData shape) {
